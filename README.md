  ...
  app:
    ...
    environment:
      ...
      # API模型，可选，设置 OPENAI_API_KEY 时可用
			# 可选参数 gpt-4,gpt-4-0314,gpt-4-32k,gpt-4-32k-0314,gpt-3.5-turbo,gpt-3.5-turbo-0301,text-davinci-003,text-davinci-002,code-davinci-002
			# 具体差异参阅 https://platform.openai.com/docs/models
