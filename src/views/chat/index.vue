...
// 主动打招呼
// function handleFirstHello() {
//   firstMsg = '你好啊，我是你的学习助手，今天想学点什么呢？我可以教你\n1. 历史 \n2. 编程'
// }
        ...
        >
          ...
          <template v-else>
            <div>
              ...
              />
              <div class="sticky bottom-2 left-0 flex justify-center">
            ...
            <div class="sticky bottom-0 left-0 flex justify-center">
              ...
              <NButton type="primary" size="large" @click="handlePlay">
                <template #icon>
                  <SvgIcon color="#ffffff" icon="ri:play-fill" />
                </template>
              </NButton>
            </div>
          </template>
