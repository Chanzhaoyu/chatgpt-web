...
import { courseStar, courseUnStar, getCourseList, getStarCourses } from '@/api'
...
<template>
  <div class="h-full w-full max-w-screen-xl m-auto dark:bg-[#101014]">
    <div class="flex flex-col items-center justify-between mt-10">
      ...
      <h1 class="flex-nowrap mt-5 text-3xl font-bold" style="color: #1B2559;">
        AI辅助PPT学习，轻松掌握课程要点
      </h1>
    </div>
    <div class="flex items-center justify-between mx-60 mt-5">
      <n-select
        class="min-w-32" size="large" filterable clearable :placeholder="placeholder" :options="courses"
